...
get_structEnrichmentPlot <- function(tad_dt, resolution_kb, proteins = default_prot, res_step = 5, plot_tit=NULL) {
   ...
   mtext(side=3, text=paste0("Hi-C resolution (kb) = ", resolution_kb,"; agg. resol. step = ",res_step))
}
